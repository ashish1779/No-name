...
void loop()
{
  ...
  { //Serial.println(PS3.getAnalogHat(RightHatY));Serial.println(PS3.getAnalogHat(RightHatX));
    ...
    if (ry <= 115 && (rx > 105 || rx < 145))     //Forward
    ...
    else if (ry >= 140 && (rx > 105 || rx < 145))     //Backward
    ...
    else if (rx >= 140 && (ry > 105 || ry < 145))     //Right
    ...
    else if (rx < 115 && (ry > 105 || ry < 145))     //Left
    { Serial.println("Left");
    ...
    { Serial.println("ForwardRight");
     ...
     else if (rx < 127 && ry > 127)     //Backward left
    ...
    if (motorSpeedA < 20)       // Prevent buzzing of motor by stoping at slow speed
    {
      motorSpeedA = 0;
    }
    if (motorSpeedB < 20)
    ...
    if (motorSpeedA > 20 && motorSpeedA < 110)       // Prevent buzzing of motor by stoping at slow speed
    {
      motorSpeedA = 80;
    }
    if (motorSpeedB > 20 && motorSpeedB < 110)
    {
      motorSpeedB = 80;
    }
    if (motorSpeedC > 20 && motorSpeedC < 110)
    {
      motorSpeedC = 80;
    }
    if (motorSpeedD > 20 && motorSpeedD < 110)
    {
      motorSpeedD = 80;
    }
    ...
    { Serial.println("Turn Clockwise");
      ...
      motorSpeedA = 225; //clockwise turn
      motorSpeedB = 225;
      motorSpeedC = 225;
      motorSpeedD = 225;
    ...
    { Serial.println("Turn Anticlockwise");
      ...
      motorSpeedA = 225; //anticlockwise turn
      motorSpeedB = 225;
      motorSpeedC = 225;
      motorSpeedD = 225;
    ...
    */
    ...
    else if (lx < 115 && (ly>105 || ly<145))     //Left
    ...
    if (PS3.getAnalogButton(UP)) //backslidder up/DOWN
    {
    ...
    if (PS3.getAnalogButton(TRIANGLE)) //LID up/DOWN
    {
      Serial.println("slidder UP");
    ...
    if (PS3.getButtonClick(SQUARE))      //Automatic
    {
      digitalWrite(in9, LOW);   // motor UP
      digitalWrite(in10, HIGH); 
      analogWrite(engripup,255);
      delay(1000);

      
      digitalWrite(in7, HIGH);  //MOTOR anticlock
      digitalWrite(in8, LOW);
      analogWrite(enrotate,250);
      delay(1600);

    }

    /*
    if (PS3.getAnalogButton(CIRCLE))      //Automatic
    {
      
      digitalWrite(in9, HIGH);   // motor UP
      digitalWrite(in10, LOW); 
      analogWrite(engripup,255);
      delay(1000);
      
      digitalWrite(in7, LOW);  //MOTOR clock
      digitalWrite(in8, HIGH);
      analogWrite(enrotate,250);
      delay(1600);
    ...
    */
    if (PS3.getButtonClick(RIGHT))
    {
      ...
      motorSpeedA = 255; //clockwise turn
      motorSpeedB = 255;
      motorSpeedC = 255;
      motorSpeedD = 255;
    ...
    else if (PS3.getButtonClick(LEFT))     //anticlockwiseturn
    { Serial.println("Turn Anticlockwise");
      digitalWrite(in1, LOW);  //MOTOR A    backward
      ...
      motorSpeedA = 255; //anticlockwise turn
      motorSpeedB = 255;
      motorSpeedC = 255;
      motorSpeedD = 255;

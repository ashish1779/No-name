...
void loop()
{
  ...
  { //Serial.println(PS3.getAnalogHat(RightHatY));Serial.println(PS3.getAnalogHat(RightHatX));
    ...
    { Serial.println("Backwardright");
      ...
      digitalWrite(in5, HIGH);  //MOTOR C    forward
      digitalWrite(in6, LOW);
    ...
    { Serial.println("Turn Clockwise");
      ...
      motorSpeedA = map(r2, 0, 255, 0, 255); //clockwise turn
      motorSpeedB = map(r2, 0, 255, 0, 255);
      motorSpeedC = map(r2, 0, 255, 0, 255);
      motorSpeedD = map(r2, 0, 255, 0, 255);
    }

    else if (l2 > 0)     //anticlockwiseturn
    { Serial.println("Turn Anticlockwise");
      ...
      digitalWrite(in5, HIGH);  //MOTOR C    backward
      digitalWrite(in6, LOW);
      ...
      motorSpeedA = map(l2, 0, 255, 0, 255); //clockwise turn
      motorSpeedB = map(l2, 0, 255, 0, 255);
      motorSpeedC = map(l2, 0, 255, 0, 255);
      motorSpeedD = map(l2, 0, 255, 0, 255);
    }
    ...
    { Serial.println("Servoclockwise");
      servomotorclockwise();
    }

    if (PS3.getButtonClick(LEFT))
    { Serial.println("Servoanticlockwise");

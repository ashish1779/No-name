...
void loop()
{
  ...
  { //Serial.println(PS3.getAnalogHat(RightHatY));Serial.println(PS3.getAnalogHat(RightHatX));
    ...
    if (motorSpeedA > 20 && motorSpeedA < 150)       // Prevent buzzing of motor by stoping at slow speed
    {
      motorSpeedA = 80;
    }
    if (motorSpeedB > 20 && motorSpeedB < 150)
    {
      motorSpeedB = 80;
    }
    if (motorSpeedC > 20 && motorSpeedC < 150)
    {
      motorSpeedC = 80;
    }
    if (motorSpeedD > 20 && motorSpeedD < 150)
    {
      motorSpeedD = 80;
    }
    ...
    */
    ...
    if (PS3.getButtonClick(UP)) //backslidder up/DOWN
    {
    ...
    if (PS3.getButtonClick(TRIANGLE)) //LID up/DOWN
    {
      Serial.println("slidder DOWN");
    ...
    if (PS3.getButtonClick(CIRCLE))      //Automatic
    {
      digitalWrite(in7, HIGH);  //MOTOR anticlock
      digitalWrite(in8, LOW);
      analogWrite(enrotate,255);
      delay(2000);
